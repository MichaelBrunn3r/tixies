...
registerTutorial('tut-x', new Tixy('', 'return x/n;', 16, 1, ['\'x\' is the column, 0..n-1']))
registerTutorial('tut-y', new Tixy('', 'return y/n;', 16, 1, ['\'y\' is the row, 0..n-1']))
registerTutorial('tut-color', new Tixy('', 'return y-(n/2-0.5);', 16, 1, ['positive numbers are white', 'negatives are red']))
