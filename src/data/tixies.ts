...
registerTutorial('tut-time', new Tixy('', 'return sin(t);', 16, 10, ['\'t\' is the time in seconds']))
...
registerTutorial('tut-animate', new Tixy('', 'return y-t;', 16, 10, ['use \'t\' to animate values']))
